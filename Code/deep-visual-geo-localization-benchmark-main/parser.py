...
def parse_arguments():
    ...
    parser.add_argument("--Ensembel", type= bool, default=False,
                        help="Folder name of the current run (saved in ./logs/)")    
    parser.add_argument("--aggregation2", type=str, default="netvlad", choices=["netvlad", "gem", "spoc", "mac", "rmac", "crn", "rrm",
                                                                               "cls", "seqpool"])
