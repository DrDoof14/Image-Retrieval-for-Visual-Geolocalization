...
def parse_arguments():
    ...
    parser.add_argument("--aggregation", type=str, default="netvlad",
    ...
    # we added this part of smart data augmentation
    parser.add_argument("--smart_augmentation", type=bool, default=None, help="_")
